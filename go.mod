module github.com/alicek106/kubectl-scheduler
...
// k8s.io/kubernetes uses local ./staging/src replaces internally; external
// consumers must pin every staging module that gets pulled in to the matching
// published version (kubernetes v1.32.x => staging v0.32.x).
replace (
